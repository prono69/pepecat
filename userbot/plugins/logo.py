...
@catub.cat_cmd(
    ...
    info={
        "header": "Makes colourful background logos ",
        "examples": "{tr}ilogo catuserbot",
        "usage": [
            "{tr}ilogo <your name>",
            "{tr}ilogo <your name> <reply to a pic>",
        ],
    },
)
async def Logo(event):
    ...
    if not text:
        await evxnt.edit("__Give some text to make a logo__")
        return
