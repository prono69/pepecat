# Sedly made by t.me/i_osho | Idea by t.me/nvmded
import os
...
async def kill_mp3(event):
	...
	if flag == " -r":
		os.system(f'ffmpeg -i {file} -af \"superequalizer=1b=20:2b=20:3b=20:4b=20:5b=20:6b=20:7b=20:8b=20:9b=20:10b=20:11b=20:12b=20:13b=20:14b=20:15b=20:16b=20:17b=20:18b=20,volume=5\" {ded_file}')
	else:
		os.system(f'ffmpeg -i {file} -filter_complex \"vibrato=f={pawer}\" {ded_file}')
	await event.edit("`Conversion done! Uploading audio.`")
	await event.client.send_file(event.chat_id, file=ded_file, caption=f"**| Successfully Destroyed |**", reply_to=reply_to_id)
	await event.delete()
