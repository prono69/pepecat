...
@catub.cat_cmd(
    command=("nekobin", plugin_category),
    info={
        "header": "To paste text to a neko bin.",
        "description": "Uploads the plugin to nekobin so that you can share plugin code with others easily.",
        "usage": ["{tr}nekoin <plugin name>"],
        "examples": [
            "{tr}nekobin alive",
        ],
    },
